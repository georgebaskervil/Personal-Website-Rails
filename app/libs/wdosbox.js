var WDOSBOX = (() => {
  ...
  return function (moduleArg = {}) {
    ...
    function emsc_add_frame_line(start, ptr, len) {
    ...
    function emsc_extract_bundle_to_fs() {
      ...
      Module.sendMessage("ws-config", { dosboxConf, jsdosConf: configContent });
    ...
    function em_net_send(networkId, datap, len) {
