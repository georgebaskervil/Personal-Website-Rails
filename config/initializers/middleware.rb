...
Rails.application.config.middleware.use Rack::Deflater, include: %w[text/html application/javascript text/css],
                                                        sync: false
Rails.application.config.middleware.use Rack::Brotli, quality: 11,
                                                      include: %w[text/html application/javascript text/css], deflater: { lgwin: 22, lgblock: 0, mode: :text }, sync: false
